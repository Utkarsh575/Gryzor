...
ss_background = pygame.image.load(os.path.join(imgFolder,'start.png')).convert()
...
PLAYER_RIGHT_6 = player_sheet.get_image(242,100,18,56).convert()
...
PLAYER_RIGHT_DOWN_0 = player_sheet.get_image(144,99,19,36).convert()
PLAYER_RIGHT_DOWN_1 = player_sheet.get_image(170,56,28,35).convert()
...
PLAYER_DEAD_0 = player_sheet.get_image(144,198,25,35).convert()
PLAYER_DEAD_1 = player_sheet.get_image(170,97,19,23).convert()
PLAYER_DEAD_2 = player_sheet.get_image(192,109,22,18).convert()
PLAYER_DEAD_3 = player_sheet.get_image(219,194,17,22).convert()
PLAYER_DEAD_4 = player_sheet.get_image(238,102,35,11).convert()
...
pygame.mixer.music.load(os.path.join(soundFolder,'Gryzor_Gryzorirt_OC_ReMix.ogv'))
